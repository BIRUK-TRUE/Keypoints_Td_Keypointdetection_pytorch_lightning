...
from backbones.convnext_unet import UpSamplingBlock
...
class MaxVitUnet(Backbone):
    ...
    # 15M params
    FEATURE_CONFIG = [{"down": 2, "channels": 64},
                      {"down": 4, "channels": 64},
                      {"down": 8, "channels": 128},
    ...
    def __init__(self, **kwargs) -> None:
        ...
        self.final_conv = nn.Conv2d(self.FEATURE_CONFIG[0]["channels"], self.FEATURE_CONFIG[0]["channels"],
                                    3, padding="same")
        self.final_upsampling_block = UpSamplingBlock(self.FEATURE_CONFIG[0]["channels"], 3,
                                                      self.FEATURE_CONFIG[0]["channels"], 3)
...
class MaxVitPicoUnet(MaxVitUnet):
    ...
    FEATURE_CONFIG = [{"down": 2, "channels": 32},
                      {"down": 4, "channels": 32},
                      {"down": 8, "channels": 64},
