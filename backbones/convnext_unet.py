...
class UpSamplingBlock(nn.Module):
    ...
    def __init__(self, n_channels_in, n_skip_channels_in, n_channels_out, kernel_size):
        ...
        self.conv1 = nn.Conv2d(in_channels=n_skip_channels_in + n_channels_in, out_channels=n_channels_out,
...
class ConvNeXtUnet(Backbone):
    ...
    def __init__(self, **kwargs):
        ...
        for i in range(1, 4):
            channels_in, skip_channels_in = (self.encoder.feature_info.info[-i]["num_chs"],
